    ...
    render(){
        return(
            <div>
                ...
                two wealthiest tiers, the donations comprise 72%, almost three quarters, of the donors. <br/><br/>And that is arguably and undercount, as 
                ...
                like central Albany, which house offices for lobbyists. <br/><br/>Many of the donors could have much higher incomes than the median for 
                ...
                <div className='blurb'>...and that's an under count. Each bar represents a quintile of the census tracts (20%). As you can see, the 
