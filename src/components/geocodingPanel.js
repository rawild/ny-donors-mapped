            ...
            <div>
                <div className='dark'>
                    ...
                    <div className='blurb'>
                        ...
                        Even with six processes running it took over 22 hours to complete the geocoding. An example of the script 
                        used can be found <a className='light-link' href="https://raw.githubusercontent.com/rawild/ny-donors-mapped/main/src/data/geocode_census.py">here</a>. <br/><br/>
